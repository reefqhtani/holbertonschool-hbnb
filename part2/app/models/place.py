...
class Place(BaseModel):
    ...
    def to_dict(self):
        ...
        # Remove the empty lists that base class added (they'll be replaced)
        if 'reviews' in place_dict:
            del place_dict['reviews']
        if 'amenities' in place_dict:
            del place_dict['amenities']
        
        # Add place attributes (they have underscore prefixes due to properties)
        ...
        if hasattr(self, '_owner') and self._owner:
            ...
            # Also include owner details as required
            place_dict['owner'] = {
                'id': self._owner.id,
                'first_name': self._owner.first_name,
                'last_name': self._owner.last_name,
                'email': self._owner.email
            }
        
        # Convert reviews and amenities to IDs and objects
        ...
        # Include amenity objects as required
